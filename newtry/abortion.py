...
print(send_message("Here are examples of persuasive and stance evaluations for statements for the topic of abortion. Use this to guide your future responses. Look for keywords such as 'prolife' 'death' 'murder' and 'kill' for supporting this topic. Make sure to make hashtags more important in your analysis:\n" + json_string,12000))
